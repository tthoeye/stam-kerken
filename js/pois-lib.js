...
function setDetailPagePoi(poi)
{
    ...
    if (email)
        contentTemplate += "<li><span class='image-icon'><img src='images/small-email.png' alt='Telephone' /></span><span class='image-text'>" + email + "</span></li>";
    if (poi.location.address.value)
        contentTemplate += "<li><span class='image-icon'><img src='images/small-address.png' alt='Address' /></span><span class='image-text'>" + poi.location.address.value + "</span></li>";
    if (openHours)
